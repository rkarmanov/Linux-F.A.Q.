...
А2: Если *pavucontrol* отсутствует, вероятно, у вас [alsa](https://ru.wikipedia.org/wiki/ALSA), тогда выполните *alsamixer* и убедитесь, что выбрано правильное устройство и нажмите “m”, если видите под графами “MM”.
